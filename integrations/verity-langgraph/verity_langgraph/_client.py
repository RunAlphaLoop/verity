# Vendored from verity-llamaindex/verity_llamaindex/_client.py — the three sink
# packages install independently, so each carries this thin client verbatim
# (SPEC §5e.4 budgets the shared-churn tax across the sink packages).
